...
const Item = ({instance}) => {
    ...
    return <List.Item  title={instance.subject}
        description={instance.created_date?moment(instance.created_date).fromNow():""} left={() => <Image style={MyStyles.avatar} source={{uri: instance.image}} />} right={()=><Button style={MyStyles.acceptBtn} mode="text"  onPress={()=>console.log('Pressed')} >Xóa</Button>} />
}
